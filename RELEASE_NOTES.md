## LightRemote v1.17 — The shake asks instead of interrupting
...
Issue titles now follow the same convention as every other app — `LightRemote v1.17.x — <headline>`,
labelled `remote` — instead of the `remote: <headline>` this app had invented.

### Reporting is a library now

The eight files under `com.gios.lightremote.report` are gone. They are
